...
namespace Microsoft.MixedReality.Toolkit
{
    ...
    public class MixedRealityToolkit : MonoBehaviour, IMixedRealityServiceRegistrar
    {
        ...
        {
            MixedRealityToolkit toolkit = FindFirstObjectByType<MixedRealityToolkit>();
        ...
        public static MixedRealityToolkit Instance
        {
            get
            {
                ...
                List<MixedRealityToolkit> mrtks = new List<MixedRealityToolkit>(FindObjectsByType<MixedRealityToolkit>(FindObjectsSortMode.None));
